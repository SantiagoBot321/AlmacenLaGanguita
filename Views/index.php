    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                <h1 class="h1">Categorías de nuestro almacén</h1>
                <p>
                    Aquí podrás encontrar las categorías para encontrar más fácil los productos que necesites.
                </p>
            </div>
        </div>
        <div class="row">
    ...
    <section class="bg-light">
        <div class="container py-5">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1">Algunos de nuestros productos más comprados</h1>
                </div>
            </div>
            <div class="row">
